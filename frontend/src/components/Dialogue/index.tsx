...
const PlanSection: FC<{ plan: CHAT.PlanItem[] }> = ({ plan }) => (
  <div>
    <div className="text-[16px] font-[600] mb-[8px]">Task planning</div>
    {plan.map((p, i) => (
      ...
      return (
        ...
        >
          ...
          <div className="px-8 flex items-center overflow-hidden">
            <div className="shrink-1">Completed</div>
      ...
      return (
        <div className="rounded-[12px] bg-[#F2F3F7] px-12 py-8 mt-[8px]">
          <div className="mb-[4px]">
            ...
            <span className="ml-[4px]">Thinking process</span>
          </div>
...
const Dialogue: FC<Props> = (props) => {
  ...
  return (
    <div className="h-full text-[14px] font-normal flex flex-col text-[#27272a]">
      ...
      {chat.tip && !chat.response ? (
        <div className="w-full rounded-[12px] mt-[24px]">
          <div className="w-full px-12 py-8 bg-[#F2F3F7] rounded-[12px]">
            <div className="mb-[4px] font-[500]">Thinking process</div>
            <div className="text-[#27272a]">{chat.tip}</div>
          </div>
        </div>
      ) : null}
